...
NEXT_ADDRESS_MIN_WAIT_TIME = 0.01  # В минутах
NEXT_ADDRESS_MAX_WAIT_TIME = 0.1  # В минутах

# Время ожидания между действиями одного аккаунта
NEXT_TX_MIN_WAIT_TIME = 4   # В секундах
NEXT_TX_MAX_WAIT_TIME = 8  # В секундах
